...
- [[[berard,Berard et al. 2001]]] Bérard, B., Bidoit, M., Finkel, A.,
  Laroussinie, F., Petit, A., Petrucci, L., Schnoebelen, P.,
  McKenzie, P. (2001): Systems and Software Verification -
  Model-Checking Techniques and Tools. Springer.  
...
- [[[jackson2006, Jackon 2006]]] Jackson, D. (2006). Software
  Abstractions: Logic, Language, and Analysis. MIT Press.
